...
from common.exceptions import RequestDBException, RequestException
...
class BaseResource(Resource):
    ...
    async def run_preprocess(self, request: Request):
        """
        Run preprocess for the endpoint
    ...
    async def run_postprocess(self):
        """
        Run postprocess for the endpoint
        """
    ...
    async def _process_request(self, request: Request, db: AsyncSession):
        ...
        # TODO: Add DB related exceptions too for rollback
            ...
            await self.db.close()
            raise e
        except (RequestDBException, RequestException) as e:
            await self.db.close()
